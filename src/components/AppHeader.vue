<template>
  <header class="header" role="banner">
    ...
    <nav class="header-actions" role="navigation" aria-label="Main actions">
      ...
      <button class="btn btn-secondary" @click="$emit('save')" aria-label="Save invoice as JSON">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
      ...
      <button class="btn btn-secondary" @click="$emit('toggle-settings')" aria-label="Open settings panel">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
